...
#### great works, just minor points
#### table take too many space, may be rotate column name  80  may turn all column name in one role.
#### figure  "% of National Deaths"  xlabel lack specific years
#### what is "aasr" in all tables or figures? change names so layman can understand.
