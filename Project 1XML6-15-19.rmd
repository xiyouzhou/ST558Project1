...
* **The function (summary) calculates the deaths and age adjusted death rate**
...
another function to list sum,mean, sd and IQR of death and age adjusted death(aadr)
...
# test  with iris   
# getsumary(as.matrix(iris %>% select(-Species)))
getsumary(as.matrix(HealthData %>% select(deaths,aadr)))
...
how to explain death increased substantially after 2009?  why deaths increase but aadr degrease? 
...
>>>>>>> ef915f932797957aa3db7819c8b187bf44d8c427
